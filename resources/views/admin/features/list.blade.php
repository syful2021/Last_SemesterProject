                        ...
                        <form class="form-horizontal" action="{{ url('admin/features/post')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name_one" class="form-control" placeholder="Enter name_one " value="" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name_two" class="form-control" placeholder="Enter name_two" value="" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" name="description_two" class="form-control" placeholder="Enter Descriptin Two"  > </textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name_three" class="form-control" placeholder="Enter name_three" value="" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" name="description_three" class="form-control" placeholder="Enter Descriptin Three"  > </textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name_four" class="form-control" placeholder="Enter name_four" value="" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" name="description_four" class="form-control" placeholder="Enter Descriptin Four"  > </textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name_five" class="form-control" placeholder="Enter name Five" value="" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" name="description_five" class="form-control" placeholder="Enter Descriptin Five"  > </textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name_six" class="form-control" placeholder="Enter name_six" value="" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" name="description_six" class="form-control" placeholder="Enter Descriptin Six"  > </textarea>
