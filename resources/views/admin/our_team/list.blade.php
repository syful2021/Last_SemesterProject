    ...
    <div class="content-wrapper">
        ...
        <section class="container">
            <div class="container-feild">
                ...
                <a href="{{ url('admin/our_team/list/' . @$getRecord[0]->id) }}" class=" btn btn-primary"
                    style="margin-bottom: 13px "> Add Our Team </a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            ...
                            <form class="form-horizontal" action="{{ url('admin/our_team/post') }}" method="post"
